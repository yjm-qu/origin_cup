...
NUM_CRZ_PER_LAYER = NUM_QUBITS - 1  # 7
NUM_RY_PER_LAYER = NUM_QUBITS       # 8
...
def train():
    ...
    # ============ 关键修改：用均匀分布初始化 ============
    np.random.seed(42)
    # 原来是: params = np.random.randn(NUM_PARAMS) * 0.1
    # 改成: 均匀分布 -π 到 π
    ...
    print(f"参数已保存到 params_test.npy")
    np.save('/home/ubuntu/origin_cup/params_test.npy', params)


if __name__ == "__main__":
    # 重定向输出到文件
    import sys
    log_file = open('/home/ubuntu/origin_cup/train_test_log.txt', 'w', buffering=1)
